	...
	if (!class_exists('wpadiro')) {
		...
		********************************************************************************/
			...
			function inject($content, $affiliateid) {
				...
				$defaultLayerCode .= 'document.write(\'<scr\'+\'ipt language="javascript1.1" src="https://adserver.adtech.de/addyn|3.0|1104|###AFFILIATEID###|1|16|ADTECH;loc=100;target=_blank;AdId=5318882;BnId=1;misc=[timestamp]"></scri\'+\'pt>\');';
